...
const rootSeed = new Uint8Array(32).fill(0xe1);
const certAuthority = ml_dsa65.keygen(rootSeed);

const certificatePayload = {
  protocol: 'Quantum-Project2-Deutsch-Jozsa',
  ...
  truthTaxonomy: {
    ...
    quantumAlgorithm: 'DEUTSCH_JOZSA_EXACT_SPEEDUP',
    qiskitTranspiler: 'QISKIT_AER_SIMULATOR_1.0',
